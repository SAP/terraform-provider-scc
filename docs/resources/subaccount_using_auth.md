...
- `authentication_data` (String, Sensitive) Subaccount authentication data, used instead of providing cloud_user, cloud_password, subaccount and region_host (as of version 2.17.0).
