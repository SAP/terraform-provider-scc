	...
	t.Run("happy path", func(t *testing.T) {
		...
		resource.Test(t, resource.TestCase{
			...
			Steps: []resource.TestStep{
				{
					Config: providerConfig("", user) + DataSourceSubaccountServiceChannel("cc_sc", "cf.us10.hana.ondemand.com", "7e8b3cba-d0af-4989-9407-bcad93929ae7", 147),
					Check: resource.ComposeAggregateTestCheckFunc(
						resource.TestCheckResourceAttr("data.cloudconnector_subaccount_service_channel_k8s.cc_sc", "credentials.region_host", "cf.us10.hana.ondemand.com"),
