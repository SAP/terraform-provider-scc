...
func TestDataSourceSystemMappingResources(t *testing.T) {
	...
	t.Run("happy path", func(t *testing.T) {
		rec, user := tfutils.SetupVCR(t, "fixtures/datasource_system_mapping_resources")
		...
		resource.Test(t, resource.TestCase{
			...
			Steps: []resource.TestStep{
				{
					Config: tfutils.ProviderConfig(user) + DataSourceSystemMappingResources("scc_smrs", regionHost, subaccount, virtualHost, virtualPort),
					Check: resource.ComposeAggregateTestCheckFunc(
						resource.TestCheckResourceAttr("data.scc_system_mapping_resources.scc_smrs", "region_host", regionHost),
						resource.TestMatchResourceAttr("data.scc_system_mapping_resources.scc_smrs", "subaccount", tfutils.RegexpValidUUID),
						...
						resource.TestMatchResourceAttr("data.scc_system_mapping_resources.scc_smrs", "system_mapping_resources.0.creation_date", tfutils.RegexpValidTimeStamp),
