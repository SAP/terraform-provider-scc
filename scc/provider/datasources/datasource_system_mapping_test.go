...
func TestDataSourceSystemMapping(t *testing.T) {
	...
	t.Run("happy path", func(t *testing.T) {
		rec, user := tfutils.SetupVCR(t, "fixtures/datasource_system_mapping")
		...
		resource.Test(t, resource.TestCase{
			...
			Steps: []resource.TestStep{
				{
					Config: tfutils.ProviderConfig(user) + DataSourceSystemMapping("scc_sm", regionHost, subaccount, virtualHost, virtualPort),
					Check: resource.ComposeAggregateTestCheckFunc(
						resource.TestCheckResourceAttr("data.scc_system_mapping.scc_sm", "region_host", regionHost),
						resource.TestMatchResourceAttr("data.scc_system_mapping.scc_sm", "subaccount", tfutils.RegexpValidUUID),
						...
						resource.TestMatchResourceAttr("data.scc_system_mapping.scc_sm", "creation_date", tfutils.RegexpValidTimeStamp),
