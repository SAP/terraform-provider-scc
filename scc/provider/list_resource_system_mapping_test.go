	...
	t.Run("happy path", func(t *testing.T) {
		...
		resource.Test(t, resource.TestCase{
			...
			Steps: []resource.TestStep{
				{
					Query:  true,
					Config: providerConfig(user) + listSystemMappingQueryConfig("scc_sm", "scc", regionHost, subaccount),
				...
				{
					Query:  true,
					Config: providerConfig(user) + listSystemMappingQueryConfigWithIncludeResource("scc_sm", "scc", regionHost, subaccount),
