...
func TestListSystemMappingResource(t *testing.T) {
	...
	t.Run("happy path", func(t *testing.T) {
		rec, user := tfutils.SetupVCR(t, "fixtures/list_resource_system_mapping_resource")
		...
		resource.Test(t, resource.TestCase{
			...
			Steps: []resource.TestStep{
				{
					Query: true,
					Config: tfutils.ProviderConfig(user) + listSystemMappingResourceQueryConfig("scc_smr", "scc",
				...
				{
					Query: true,
					Config: tfutils.ProviderConfig(user) + listSystemMappingResourceQueryConfigWithIncludeResource("scc_smr", "scc",
	...
	t.Run("error path - subaccount not found", func(t *testing.T) {
		rec, user := tfutils.SetupVCR(t, "fixtures/list_resource_system_mapping_resource_error_subaccount_not_found")
