...
func TestListSystemMapping(t *testing.T) {
	...
	t.Run("happy path", func(t *testing.T) {
		rec, user := tfutils.SetupVCR(t, "fixtures/list_resource_system_mapping")
		...
		resource.Test(t, resource.TestCase{
			...
			Steps: []resource.TestStep{
				{
					Query:  true,
					Config: tfutils.ProviderConfig(user) + listSystemMappingQueryConfig("scc_sm", "scc", regionHost, subaccount),

					QueryResultChecks: []querycheck.QueryResultCheck{
						querycheck.ExpectLength("scc_system_mapping.scc_sm", 1),
				...
				{
					Query:  true,
					Config: tfutils.ProviderConfig(user) + listSystemMappingQueryConfigWithIncludeResource("scc_sm", "scc", regionHost, subaccount),
	...
	t.Run("error path - subaccount not found", func(t *testing.T) {
		rec, user := tfutils.SetupVCR(t, "fixtures/list_resource_system_mapping_error_subaccount_not_found")
