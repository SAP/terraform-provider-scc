...
func TestSystemCertificatePKCS12Certificate_ShouldUpdate_Change(t *testing.T) {
	...
	state := PKCS12SystemCertificateResourceConfig{
...
func TestCreateInternal_ValidationFails(t *testing.T) {
	...
	_, diags := createPKCS12SystemCertificateFunc(r, context.Background(), plan)
...
func TestCreateInternal_ModelConversionFails(t *testing.T) {
	...
	pkcs12SystemCertificateResourceValueFromFunc = func(context.Context, apiobjects.Certificate) (PKCS12SystemCertificateResourceConfig, diag.Diagnostics) {
		var d diag.Diagnostics
...
func TestCreateInternal_Success(t *testing.T) {
	...
	pkcs12SystemCertificateResourceValueFromFunc = func(ctx context.Context, obj apiobjects.Certificate) (PKCS12SystemCertificateResourceConfig, diag.Diagnostics) {
	...
	state, diags := createPKCS12SystemCertificateFunc(r, context.Background(), plan)
