...
func (r *CACertificatePKCS12CertificateResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan model.PKCS12CACertificateResourceConfig
...
func (r *CACertificatePKCS12CertificateResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	var state model.PKCS12CACertificateResourceConfig
	...
	d = helpers.ValidatePEMDataFunc(string(pemBytes))
	resp.Diagnostics.Append(d...)
	if resp.Diagnostics.HasError() {
		return
	}

	responseModel, d := model.PKCS12CACertificateResourceValueFromFunc(ctx, respObj)
	resp.Diagnostics.Append(d...)
	if resp.Diagnostics.HasError() {
		return
	}
...
func (r *CACertificatePKCS12CertificateResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state model.PKCS12CACertificateResourceConfig
	diags := req.Plan.Get(ctx, &plan)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
...
var CreatePKCS12CACertificateFunc = func(r *CACertificatePKCS12CertificateResource, ctx context.Context, plan model.PKCS12CACertificateResourceConfig) (*model.PKCS12CACertificateResourceConfig, diag.Diagnostics) {
	...
	d = helpers.UploadPKCS12CertificateFunc(r.Client, endpoint, rawCertificate, plan.Password.ValueString(), keyPassword)
	diags.Append(d...)
	if diags.HasError() {
		return nil, diags
	}
