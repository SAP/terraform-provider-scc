...
func (r *CACertificateSignedChainResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var plan model.SignedChainCACertificateResourceConfig
...
func (r *CACertificateSignedChainResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	...
	var state model.SignedChainCACertificateResourceConfig
	...
	responseModel, diags := model.SignedChainCACertificateResourceValueFromFunc(ctx, respObj)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
	}
...
func (r *CACertificateSignedChainResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var plan, state model.SignedChainCACertificateResourceConfig
	diags := req.Plan.Get(ctx, &plan)
	resp.Diagnostics.Append(diags...)
	if resp.Diagnostics.HasError() {
		return
...
var CreateSignedChainCACertificateFunc = func(r *CACertificateSignedChainResource, ctx context.Context, signedChain string) (*model.SignedChainCACertificateResourceConfig, diag.Diagnostics) {
	...
	responseModel, d := model.SignedChainCACertificateResourceValueFromFunc(ctx, respObj)
	diags.Append(d...)
	if diags.HasError() {
		return nil, diags
	}
