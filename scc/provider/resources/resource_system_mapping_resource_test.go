...
func TestResourceSystemMappingResource(t *testing.T) {
	...
	t.Run("happy path", func(t *testing.T) {
		rec, user := tfutils.SetupVCR(t, "fixtures/resource_system_mapping_resource")
		...
		resource.Test(t, resource.TestCase{
			...
			Steps: []resource.TestStep{
				{
					Config: tfutils.ProviderConfig(user) + ResourceSystemMappingResource("scc_smr", regionHost, subaccount, virtualHost, virtualPort, "/", "create resource", true),
				...
				},
				{
					...
					Config: tfutils.ProviderConfig(user) + ResourceSystemMappingResource("scc_smr", regionHost, subaccount, virtualHost, virtualPort, "/", "updated resource", false),
					Check: resource.ComposeAggregateTestCheckFunc(
				...
				/*{
					Config: tfutils.ProviderConfig(user) + ResourceSystemMappingResource("scc_smr", "cf.us10.hana.ondemand.com", subaccount, virtualHost, virtualPort, "/", "updated resource", false),
	...
	t.Run("error path - requires replace", func(t *testing.T) {
		rec, user := tfutils.SetupVCR(t, "fixtures/resource_system_mapping_resource.requires_replace")
		defer tfutils.StopQuietly(rec)
		...
		resource.Test(t, resource.TestCase{
			...
			Steps: []resource.TestStep{
				...
				{
					Config: tfutils.ProviderConfig(user) + ResourceSystemMappingResource("scc_smr", "cf.us10.hana.ondemand.com", subaccount, virtualHost, virtualPort, "/", "create resource", true),
					ConfigPlanChecks: resource.ConfigPlanChecks{
						PreApply: []plancheck.PlanCheck{
							plancheck.ExpectResourceAction("scc_system_mapping_resource.scc_smr", plancheck.ResourceActionDestroyBeforeCreate),
						},
